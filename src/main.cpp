...
int main([[maybe_unused]] int argc, [[maybe_unused]] const char **argv) {
  ...
  // Initializers
  [[maybe_unused]] auto a3 = nc::linspace<int>(1, 10, 5);
  [[maybe_unused]] auto a4 = nc::arange<int>(3, 7);
  [[maybe_unused]] auto a5 = nc::eye<int>(4);
  [[maybe_unused]] auto a6 = nc::zeros<int>(3, 4);
  [[maybe_unused]] auto a7 = nc::NdArray<int>(3, 4) = 0;
  [[maybe_unused]] auto a8 = nc::ones<int>(3, 4);
  [[maybe_unused]] auto a9 = nc::NdArray<int>(3, 4) = 1;
  [[maybe_unused]] auto a10 = nc::nans(3, 4);
  [[maybe_unused]] auto a11 = nc::NdArray<double>(3, 4) = nc::constants::nan;
  [[maybe_unused]] auto a12 = nc::empty<int>(3, 4);
  [[maybe_unused]] auto a13 = nc::NdArray<int>(3, 4);

  // Slicing/Broadcasting
  [[maybe_unused]] auto a14 = nc::random::randInt<int>({10, 10}, 0, 100);
  [[maybe_unused]] auto value = a14(2, 3);
  [[maybe_unused]] auto slice = a14({2, 5}, {2, 5});
  [[maybe_unused]] auto rowSlice = a14(a14.rSlice(), 7);
  [[maybe_unused]] auto values = a14[a14 > 50];
  a14.putMask(a14 > 50, 666);

  // random
  nc::random::seed(666);
  [[maybe_unused]] auto a15 = nc::random::randN<double>({3, 4});
  [[maybe_unused]] auto a16 = nc::random::randInt<int>({3, 4}, 0, 10);
  [[maybe_unused]] auto a17 = nc::random::rand<double>({3, 4});
  [[maybe_unused]] auto a18 = nc::random::choice(a17, 3);

  // Concatenation
  [[maybe_unused]] auto a = nc::random::randInt<int>({3, 4}, 0, 10);
  [[maybe_unused]] auto b = nc::random::randInt<int>({3, 4}, 0, 10);
  [[maybe_unused]] auto c = nc::random::randInt<int>({3, 4}, 0, 10);
  [[maybe_unused]] auto a19 = nc::stack({a, b, c}, nc::Axis::ROW);
  [[maybe_unused]] auto a20 = nc::vstack({a, b, c});
  [[maybe_unused]] auto a21 = nc::hstack({a, b, c});
  [[maybe_unused]] auto a22 = nc::append(a, b, nc::Axis::COL);

  // Diagonal, Traingular, and Flip
  [[maybe_unused]] auto d = nc::random::randInt<int>({5, 5}, 0, 10);
  [[maybe_unused]] auto a23 = nc::diagonal(d);
  [[maybe_unused]] auto a24 = nc::triu(a);
  [[maybe_unused]] auto a25 = nc::tril(a);
  [[maybe_unused]] auto a26 = nc::flip(d, nc::Axis::ROW);
  [[maybe_unused]] auto a27 = nc::flipud(d);
  [[maybe_unused]] auto a28 = nc::fliplr(d);
  ...
  (void)a35; // silence unused warning

  // Comparisons
  [[maybe_unused]] auto a36 = nc::equal(a, b);
  [[maybe_unused]] auto a37 = a == b;
  [[maybe_unused]] auto a38 = nc::not_equal(a, b);
  [[maybe_unused]] auto a39 = a != b;
  [[maybe_unused]] auto [rows, cols] = nc::nonzero(a);
  ...
  (void)value9; // silence unused variable warning
